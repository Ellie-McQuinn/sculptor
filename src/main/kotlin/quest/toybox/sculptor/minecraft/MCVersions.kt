...
enum class MCVersions(
    ...
    MC_1_20_4_RC_1(
        string = "1.20.4-rc1",
        normalizedString = "1.20.4-rc.1",
        minimumFabricLoaderVersion = "0.14.23",
        neoFormVersion = "1.20.4-rc1-20231206.173914"
    ),
    MC_1_20_4(
        string = "1.20.4",
        normalizedString = "1.20.4",
        minimumFabricLoaderVersion = "0.14.23",
    ...
    POISONOUS_POTATO(
        string = "24w14potato",
        normalizedString = "1.20.5-alpha.24.12.potato",
    ...
    MC_1_21_5(
        string = "1.21.5",
        normalizedString = "1.21.5",
        minimumFabricLoaderVersion = "0.16.10",
        neoFormVersion = "1.21.5-20250325.162830"
    ),
    // endregion
    CRAFT_MINE(
        string = "25w14craftmine",
        normalizedString = "1.21.6-alpha.25.14.craftmine",
    ...
    fun isRelease(): Boolean {
        return Regex("\\d+\\.\\d+(\\.\\d+)?").matches(string)
    }
